...
\begin{itemize}
    \item{Tech Lead for a team of backend and machine learning engineers.} % Leadership
    \item{Improved Terms of Service violation enforcement by more than $20\%$ with Large Language Models.} % MKB LLM
    \item{Created new service to centralize information about merchant business models. } %MKB service
