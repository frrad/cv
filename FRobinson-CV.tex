...
\begin{itemize}
    \item{Tech Lead on a team of backend and machine learning engineers.} % Leadership
    ...
    \item{Maintained transformers-based merchant website text classfication model. } %MKB service      
\end{itemize}
}
